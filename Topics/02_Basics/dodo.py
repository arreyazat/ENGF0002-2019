...
def task_build():
    """build cmd """
    return {
        'actions': ['pdflatex -shell-escape 02_Basics_Slides ;pdflatex -shell-escape 02_Basics_Slides ; bibtex 02_Basics_Slides ; pdflatex -shell-escape 02_Basics_Slides',],
        'file_dep': ["testreport.txt"] + Python_files +
                     ["02_Basics_Slides.tex"],
        'targets': ["02_Basics_Slides.pdf"],
        'verbosity': 2,
        }
