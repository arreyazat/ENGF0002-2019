...
\item Programming is foundational and an important part of it.
\end{itemize}
...
You must \emc{test code in documentation}. \\ \texttt{pytest -vs -${\texttt -}$doctest-modules test\_hello\_world.py}.
...
\begin{frame}
  ...
  \begin{variableblock}{Bug report}{bg=stone,fg=black}{bg=black,fg=white}
    \begin{itemize}
    \item Under certain workloads, people waiting for the lift starve to death.
    \end{itemize}
  \end{variableblock}
\end{frame}
...
\begin{frame}
  ...
  \end{block}
  \vspace{1mm}
  \begin{variableblock}{Revised Bug report}{bg=stone,fg=black}{bg=black,fg=white}
    \begin{itemize}
...
%  \vspace{5mm}
  \begin{variableblock}{Revised Bug report}{bg=stone,fg=black}{bg=black,fg=white}
    \begin{itemize}
    \item Under certain workloads, people waiting for the lift starve to death before it reaches their floor.
    \end{itemize}
  \end{variableblock}
  \vspace{1mm}
  \begin{block}{Diagnosis}
